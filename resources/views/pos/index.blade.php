    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6 col-6 mt-5 right_border">
          ...
          <div class="row mt-4">
            <div class="col-4">
              <div class="card btn_add_to_cart" data-id="1" data-item_name="Item One" data-image="template/images/businesswoman-using-tablet-analysis.jpg" data-sell_price= "100">
                <div class="card-img">
            ...
            <div class="col-4">
              <div class="card btn_add_to_cart" data-id="2" data-item_name="Item Two" data-image="template/images/businesswoman-using-tablet-analysis.jpg" data-sell_price= "100">
                <div class="card-img">
                  <div class="product_list">
                    <img src="{{ asset('template/images/businesswoman-using-tablet-analysis.jpg') }}" alt=""
                      class="img-fluid rounded-start">
            ...
            <div class="col-4">
              <div class="card btn_add_to_cart" data-id="3" data-item_name="Item Three" data-image="template/images/businesswoman-using-tablet-analysis.jpg" data-sell_price= "100">
                <div class="card-img">
                  <div class="product_list">
                    <img src="{{ asset('template/images/businesswoman-using-tablet-analysis.jpg') }}" alt=""
                      class="img-fluid rounded-start">
