              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-6">
                    ...
                    <input type="text" name="shop_name" class="form-control mb-2" id="shop_name" value="{{ $shop->name }}">
                    @error('shop_name')
                      <span class="text-danger pt-4 mt-5" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
                  ...
                  <div class="col-lg-6 col-6">
                    ...
                    <input type="text" name="shop_phone" class="form-control mb-2" id="shop_phone" value="{{ $shop->phone }}">
                    @error('shop_phone')
                      <span class="text-danger pt-4 mt-5" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
                ...
                <div class="row my-2">
                  ...
                  <div class="col-lg-6 col-4">
                    ...
                    <input type="text" name="tax" class="form-control mb-2" id="tax" value="{{ $shop->tax }}">
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-4 col-4 mx-auto">
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary mt-4 py-2" style="max-width: 100%">Update</button>
                    </div>
                  </div>
                </div>
